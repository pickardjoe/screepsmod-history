...
let ENV = {
  ...
  accessKeyId:
    process.env.HISTORY_ACCESS_KEY_ID || process.env.AWS_ACCESS_KEY_ID,
  secretAccessKey:
    process.env.HISTORY_SECRET_ACCESS_KEY || process.env.AWS_SECRET_ACCESS_KEY,
...
class AWSAdapter {
  constructor(opts) {
    this.opts = Object.assign({}, opts, {
      endpoint: new AWS.Endpoint(opts.endpoint)
    });
    this.s3 = new AWS.S3(this.opts);
  }
  getFilePath(room, tick) {
